...
export function listener<T,  This = unknown>(this: This, listeners = new Set<Listener<T>>()) {
  return  Object.assign(function fire(this:This,val:T){
    listeners.forEach((v) => v(val), this);
  }, {
